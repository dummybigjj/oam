    <!-- View History Modal -->
    <div id="GenerateSubjectCodeAttendanceReport" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left forms" style="overflow: hidden;">
          ...
          <form action="<?php echo site_url('admin/generate_subject_code_attendance_report'); ?>" id="formGenerateSubjectCodeAttendanceReport" method="post" accept-charset="utf-8">
            <div class="modal-body">
              ...
              <div class="form-group col-md-12">
                ...
                <select name="subject_code" id="subject_code" required="" class="select_search form-control" style="width: 100%"></select>
              </div>
