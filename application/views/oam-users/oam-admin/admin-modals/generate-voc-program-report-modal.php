    <!-- View History Modal -->
    <div id="GenerateVocProgramAttendanceReport" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left forms">
      <div role="document" class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="<?php echo site_url('admin/generate_voc_program_attendance_report'); ?>" id="formGenerateVocProgramAttendanceReport" method="post" accept-charset="utf-8">
