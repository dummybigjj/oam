    <!-- View History Modal -->
    <div id="GenerateStudentsAttendanceReport" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left forms" style="overflow: hidden;">
      <div role="document" class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="<?php echo site_url('admin/generate_students_attendance_report'); ?>" id="formGenerateStudentsAttendanceReport" method="post" accept-charset="utf-8">
