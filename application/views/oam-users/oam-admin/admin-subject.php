                      ...
                      <table id="example" class="table table-striped bg-white table-bordered" cellspacing="0" width="100%">
                        ...
                        <?php if(!empty($subject)): ?>
                          <?php foreach($subject as $value): ?>
                              <tr>
                                <td><input type="checkbox" class="checkbox-template" name="subject_id[]" value="<?php echo $value['subject_id'] ?>" /></td>
                                ...
                                <td>
                                  <button type="button" class="btn btn-warning" onclick="edit_subject(<?php echo $value['subject_id'];?>)"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button>
                                </td>
                              </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
