...
class User_model extends CI_Model {
	...
	public function changeUserPassword($new_password){
        ...
        $change_pass  = $this->crud->updateData(array('u_password'=>$new_password,'password_reset_date'=>$reset_date),array('user_id'=>$this->session->userdata('user_id')),'tbl1');
        if($change_pass){
        	return TRUE;
        }
        return FALSE;
